      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div data-aos="fade-right" data-aos-delay="200">
            <h3 className="text-3xl font-bold text-gray-900 mb-6">
              Our <span className="gradient-text text-shimmer">Story</span>
            </h3>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We've successfully delivered over <span className="gradient-text text-shimmer">10 projects</span>, ranging from simple websites to 
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700 font-medium">5+ Team Members</span>
              </div>
            </div>
          </div>
        ...
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-gray-900 text-center mb-12" data-aos="fade-up">
            Our <span className="gradient-text text-shimmer">Core Values</span>
          </h3>
        ...
        <div>
          <h3 className="text-3xl font-bold text-gray-900 text-center mb-12" data-aos="fade-up">
            Meet Our <span className="gradient-text text-shimmer">Leadership Team</span>
          </h3>
          <div className={`grid gap-8 ${team.length < 3 ? 'grid-cols-1 md:grid-cols-2 justify-center' : 'md:grid-cols-2 lg:grid-cols-4'}`}>
