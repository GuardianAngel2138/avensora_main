  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      details: "sales@avensora.in",
      description: "Send us an email anytime!",
      action: () => window.open('mailto:sales@avensora.in', '_blank')
    },
    {
      icon: Phone,
      title: "Call Us",
    ...
    },
    {
      ...
      action: () => window.open('https://maps.app.goo.gl/FhiN9WaNwMAfTRJW8', '_blank')
    }
  ];
